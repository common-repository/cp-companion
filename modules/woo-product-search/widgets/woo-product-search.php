<?php
namespace CpCompanion\Modules\WooProductSearch\Widgets;
...
class Woo_Product_Search extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'WooProduct Search', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-woo-product-search';
    }
    ...
    protected function _register_controls() {   
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Search Options', 'cp-companion' ),
            ]
        );
        ...
        $this->add_control(
            'search_placeholder',
            [
                'label'         => esc_html__( 'Search Placeholder Text', 'cp-companion' ),
                'type'          => Controls_Manager::TEXT,
                'default'       => esc_html__('Search Products Here','cp-companion'),
            ]
        );
        ...
        $this->add_control(
            'cat_text',
            [
                'label'         => esc_html__( 'All Categories Text', 'cp-companion' ),
                'type'          => Controls_Manager::TEXT,
                'default'       => esc_html__('All Categories','cp-companion'),
            ]
        );
    ...
    protected function render() {
      ...
      $this->add_render_attribute( 'cp-attr', 'class', 'cp-woo-product-search' );
      ...
      <div <?php echo $this->get_render_attribute_string('cp-attr')?> >
       <?php 
            ...
            $categories_show = '<option value="0">'.esc_html__('All Categories','cp-companion').'</option>';
            $check = '';
            if(is_search()){
