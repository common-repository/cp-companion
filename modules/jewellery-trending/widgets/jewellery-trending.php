<?php
namespace CpCompanion\Modules\JewelleryTrending\Widgets;
...
class Jewellery_Trending extends Widget_Base {
	...
	public function get_name() {
		return 'cp-jewellery-trending-product';
	}

	public function get_title() {
		return  esc_html__( 'Jewellery Trending Product', 'cp-companion' );
	}
	...
	protected function _register_controls() {	
        ...
        */
        ...
        $this->add_control(
            'cat_color',
            [
                'label'     => esc_html__( 'Categories Color', 'cp-companion' ),
    ...
    protected function render() {
      ...
      $this->add_render_attribute( 'cp-attr', 'class', 'cp-jew-trending-product-main-wrapp ' );
