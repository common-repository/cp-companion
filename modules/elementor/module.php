<?php
namespace CpCompanion\Modules\Elementor;
...
class Module extends Module_Base {
	...
	public function register_controls_sticky($section, $section_id, $args) {
		...
		$section->add_control(
			'section_sticky_on',
			[
				'label'        => esc_html__( 'Enable Sticky', 'cp-companion' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'description'  => esc_html__( 'Enable this to set sticky feature.', 'cp-companion' ),
			]
		);
