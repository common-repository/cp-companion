<?php
namespace CpCompanion\Modules\BlogModule2\Widgets;
...
class Blog_Module2 extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'Blog Module 2', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-blog-module2';
    }
    ...
    protected function _register_controls() {   
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Featured Image Settings', 'cp-companion' ),
            ]
        );
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Large Image Style', 'cp-companion' ),
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Small Images Styles', 'cp-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'cp-attr', 'class', 'cp-blog-module2 ' );
