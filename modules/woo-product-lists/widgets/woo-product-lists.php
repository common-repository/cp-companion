<?php
namespace CpCompanion\Modules\WooProductLists\Widgets;
...
class Woo_Product_Lists extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'WooProduct List', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-woo-product-list';
    }
    ...
    protected function render() {
      ...
      $this->add_render_attribute( 'cp-attr', 'class', 'cp-woo-product-lists ' );
