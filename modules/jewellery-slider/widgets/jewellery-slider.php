<?php
namespace CpCompanion\Modules\JewellerySlider\Widgets;
...
class Jewellery_Slider extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'Jewellery Slider Product', 'cp-companion' );
    }
    ...
    protected function _register_controls() {   
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Add to Cart Hover Color', 'cp-companion' ),
                'type'      => Controls_Manager::COLOR,
                'separator' => 'before',
                'selectors' => [
    ...
    protected function render() {
      ...
      $this->add_render_attribute( 'cp-attr', 'class', 'cp-jew-trending-slider-main-wrapp ' ); ?>
