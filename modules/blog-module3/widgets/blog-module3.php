<?php
namespace CpCompanion\Modules\BlogModule3\Widgets;
...
class Blog_Module3 extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'Blog Module 3', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-blog-module3';
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'cp-attr', 'class', 'cp-blog-module3 ' );
