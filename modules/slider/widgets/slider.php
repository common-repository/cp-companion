<?php
namespace CpCompanion\Modules\Slider\Widgets;
...
class Slider extends Widget_Base {
	...
	public function get_title() {
		return  esc_html__( 'Slider 1', 'cp-companion' );
	}

	public function get_icon() {
		return 'cp-ea-icons cp-ea-sl1';
	}
	...
	protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .cp-companion-slider .inner-wrapp .contents-wrapp .slider-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
	...
	protected function render() {
		...
		$this->add_render_attribute( 'cp-companion-attr', 'class', 'cp-companion-slider ' );
	?>
