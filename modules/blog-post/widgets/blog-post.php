<?php
namespace CpCompanion\Modules\BlogPost\Widgets;
...
class Blog_Post extends Widget_Base {
	...
	public function get_title() {
		return  esc_html__( 'Blog Posts', 'cp-companion' );
	}

	public function get_icon() {
		return 'cp-ea-icons cp-blog-post';
	}
	...
	protected function _register_controls() {	
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Layouts', 'cp-companion' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'		=> 'style1',
				'options' 		=> [
					'style1'  	=> esc_html__( 'Style 1', 'cp-companion' ),
					'style2' 	=> esc_html__( 'Style 2', 'cp-companion' ),
					'style3' 	=> esc_html__( 'Style 3', 'cp-companion' ),
                    'style4'    => esc_html__( 'Style 4', 'cp-companion' ),
                    'style5'    => esc_html__( 'Style 5', 'cp-companion' ),
                    'style6'    => esc_html__( 'Style 6', 'cp-companion' ),
                    'style7'    => esc_html__( 'Style 7', 'cp-companion' ),
                    'style8'    => esc_html__( 'Style 8', 'cp-companion' ),
                    'style9'    => esc_html__( 'Style 9', 'cp-companion' ),
                ],
            ]
        );
		...
		$this->add_control(
			'excerpt_length',
			[
				'label'       => esc_html__( 'Excerpt Length', 'cp-companion' ),
        ...
        $this->add_control(
            'btn_color',
            [
                'label'     => esc_html__( 'Button/Read More Color', 'cp-companion' ),
                'type'      => Controls_Manager::COLOR,
                'separator' => 'before',
                'condition' => [
                    'layouts!' => 'style2',
        ...
        $this->add_control(
            'date_color',
            [
                'label'     => esc_html__( 'Date Color', 'cp-companion' ),
                'type'      => Controls_Manager::COLOR,
                'separator' => 'before',
                'condition' => [
                    'layouts!' => 'style1',
    ...
    protected function render() {
      ...
      $this->add_render_attribute( 'cp-attr', 'class', 'cp-blog-post-main-wrapp '.$layouts );
        ...
        <div class="item-wrapp">
            ...
            <div class="content-wrapp">
                ...
                <div class="post-content">
                    <?php cp_ea_get_excerpt_content($excerpt_length) ?>
                </div>
                <a href="<?php the_permalink() ?>" class="btn-read-more"><?php esc_html_e('Read More','cp-companion'); ?></a>
            </div>
        </div>
    <?php }
