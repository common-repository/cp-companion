<?php
namespace CpCompanion\Modules\BlogModule1\Widgets;
...
class Blog_Module1 extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'Blog Module 1', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-blog-module1';
    }
    ...
    protected function _register_controls() {   
        ...
        $this->add_control(
            'no_of_col',
            [
                'label'         => esc_html__( 'Number Of Columns', 'cp-companion' ),
                'type'          => Controls_Manager::NUMBER,
                'default'       => 4,
                'min'           => 1,
                'max'           => 4
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'cp-attr', 'class', 'cp-blog-module1 ' );
