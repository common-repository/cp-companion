<?php
namespace CpCompanion\Modules\AuthorInfo\Widgets;
...
class Author_Info extends Widget_Base {
    ...
    public function get_title() {
        return  esc_html__( 'Author Info', 'cp-companion' );
    }

    public function get_icon() {
        return 'cp-ea-icons cp-ea-author';
    }
    ...
    protected function _register_controls() {   
        ...
        $this->add_control(
            'foreground_img',
            [
                'label'       => esc_html__( 'Foreground Image', 'cp-companion' ),
        ...
        $this->add_control(
            'author_img',
            [
                'label'       => esc_html__( 'Author Image', 'cp-companion' ),
                'type'        => Controls_Manager::MEDIA,
            ]
        );
        ...
        $this->add_control(
            'author_name',
            [
                'label'       => esc_html__( 'Author Name', 'cp-companion' ),
        ...
        */
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .name-wrapp' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .name-wrapp',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .designation' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Typography', 'cp-companion' ),
                'scheme'    => Scheme_Typography::TYPOGRAPHY_4,
                'selector'  => '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .designation',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .description' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Typography', 'cp-companion' ),
                'scheme'    => Scheme_Typography::TYPOGRAPHY_4,
                'selector'  => '{{WRAPPER}} .cp-author-info .module-inner-wrapp .content-wrapper .description',
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'cp-attr', 'class', 'cp-author-info ' );
