...
final class Modules_Manager {
    ...
    private function require_files() {
        include_once( CP_COMPANION_PATH . 'base/module_base.php' );
    }
    ...
    public function register_modules() {
        ...
        //load only for Century Parallax Theme
    ...
    public function __construct() {
        ...
        add_action('cp_comp_register_modules',array($this,'register_modules'),10 );
    }

}

if ( !function_exists( 'cp_module_manager' ) ) {
